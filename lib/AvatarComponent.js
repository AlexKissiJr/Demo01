...
function jqVerHandling() {
  return _jqVerHandling.apply(this, arguments);
}
function _jqVerHandling() {
  _jqVerHandling = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var siteJq, site$;
...
var AvatarComponent = function AvatarComponent(data) {
  var url;
  if (data.id) {
    if (data.env) {
      if (data.env == 'dev') {
